 ...
 * @since 1.0.0
 */
public class ValidateException extends AbstractRequestRuntimeException {
    /**
     * BindingResult
     */
    ...
    public String getMessage() {
        return this.getErrorInfo()
                ...
                .getLocalMessage(AppContext.getInstance().applicationContext(), AppContext.getInstance().getLocale());
    }
}
