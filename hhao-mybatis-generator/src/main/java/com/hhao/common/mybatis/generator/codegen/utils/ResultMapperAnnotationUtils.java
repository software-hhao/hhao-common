 ...
 */
public class ResultMapperAnnotationUtils {
    ...
    public static String generatorBaseResultMapId(IntrospectedTable introspectedTable){
        ...
        if (name!=null && !name.isBlank()){
            name= GeneratorStringUtils.getLastSegmentAfterDot(name)+ "Result";
        }else{
            name= GeneratorStringUtils.capitalizeFirstLetter(introspectedTable.getFullyQualifiedTableNameAtRuntime()) + "Result";
        }
