...
public abstract class AbstractComponentExecutor {
     ...
     * @return
     */
//    public <R, T> R execute(Class<T> targetClz, BizCoordinate bizScenario, Function<T, R> exeFunction) {
...
//    }
     ...
     * @param <T> Parameter Type
     */
//    public <T> void executeVoid(Class<T> targetClz, BizCoordinate context, Consumer<T> exeFunction) {
...
//    }
//
//    protected abstract <C> C locateComponent(Class<C> targetClz, BizCoordinate context);
}
