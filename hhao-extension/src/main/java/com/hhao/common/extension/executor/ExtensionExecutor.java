...
//
//    @Override
//    protected <C> C locateComponent(Class<C> targetClz, BizCoordinate bizScenario) {
...
//     * @param targetClz
//     */
//    protected <Ext> Ext locateExtension(Class<Ext> targetClz, BizCoordinate bizScenario) {
...
//     */
//    private  <Ext> Ext firstTry(Class<Ext> targetClz, BizCoordinate bizScenario) {
...
//     */
//    private <Ext> Ext secondTry(Class<Ext> targetClz, BizCoordinate bizScenario){
...
//     */
//    private <Ext> Ext defaultUseCaseTry(Class<Ext> targetClz, BizCoordinate bizScenario){
...
//    }
//
//    private void checkNull(BizCoordinate bizScenario){
//        if(bizScenario == null){
